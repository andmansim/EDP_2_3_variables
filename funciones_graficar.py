...
# de la cadena colgante (Solución numérica)
# ===========================================
def visualizar_evolucion_numerica(w,historial_w, x):
    '''
    Visualizamos los distintos estados de la solución numérica de la cadena colgante en el tiempo. 
    ...
    ani.save("cadena_colgante/graficas/numerica/animacion_sol_numerica.gif", writer="pillow", fps=5)
    plt.show()
...
# ===========================================
# Visualizar evolución 
# de la cadena colgante (Solución teórica)
# ===========================================
def visualizar_evolucion_teorica(w ,historial_w, x):
    '''
    Visualizamos los distintos estados de la solución teóica de la cadena colgante en el tiempo. 
    Esta se representa como una serie de puntos en el plano (u(x,t), x).
    ...
    #blit=True hace que solo se actualicen los puntos que cambian, no toda la figura
    ani = animation.FuncAnimation(fig, actualizar, frames=len(tiempos), interval=210, blit=False, repeat=False)
    ani.save("cadena_colgante/graficas/teorica/animacion_sol_teorica.gif", writer="pillow", fps=5)
    plt.show()
    
#======================================
# Función para guardar las imagenes 
# de la animación de la cadena colgante
#======================================
def guardar_imagen_cadena(x,y,i, tipo):
    '''
    Guardamos imágenes de la animación de la cadena colgante en un tiempo especifico.
    '''
    # Definimos la ruta, el nombre del archivo y la extensión
    nombre_archivo = "cadena_colgante_paso_{}.png".format(i)
    directorio = f"cadena_colgante/graficas/{tipo}/"
    ruta_completa = os.path.join(directorio, nombre_archivo)
