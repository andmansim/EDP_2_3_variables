...
def animar_comparacion(resultados_numericos, resultados_teoricos):
    ...
    img = mpimg.imread("cadena_colgante/graficas_cadena/fondo_habita.png")
    ...
    def update(frame):
        ...
        # ax1.set_title(f"Tiempo: {frame}", fontsize=12, fontweight='bold')
    ...
    ani.save("cadena_colgante/graficas_cadena/comparacion_num_teo_cadena.gif", writer="pillow", fps=5)
    plt.show()
...
def fotos_animacion(resultados_numericos, resultados_teoricos):
    ...
    for frame in tiempos_a_guardar:
        ...
        plt.savefig(f"cadena_colgante/graficas_cadena/representacion_tiempo_{frame}.png", dpi=200)
        plt.close(fig)


if __name__ == "__main__":
    # Cargar los archivos de resultados
    resultados_teoricos = pd.read_csv('cadena_colgante/solucion_cadena/u_fokker_plank.csv', header=None)
    resultados_numericos = pd.read_csv('cadena_colgante/solucion_cadena/w_cadena_colgante.csv', header=None)
    ...
    plt.savefig("cadena_colgante/graficas_cadena/mapa_calor_cad_teo_cad_num.png", dpi=300)
    plt.show()
    ...
    plt.savefig("cadena_colgante/graficas_cadena/comparacion_oscilaciones_cadenas.png", dpi=300)  # Guardar la figura
    plt.show()
